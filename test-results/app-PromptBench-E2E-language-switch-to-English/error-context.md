...
- Name: app.spec.ts >> PromptBench E2E >> language switch to English
- Location: e2e\app.spec.ts:57:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3006/
Call log:
  - navigating to "http://localhost:3006/", waiting until "load"
