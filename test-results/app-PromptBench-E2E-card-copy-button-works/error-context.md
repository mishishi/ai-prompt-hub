...
- Name: app.spec.ts >> PromptBench E2E >> card copy button works
- Location: e2e\app.spec.ts:67:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3006/library
Call log:
  - navigating to "http://localhost:3006/library", waiting until "load"
